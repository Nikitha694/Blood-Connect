...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['blood_type'])) {
    ...
    $sql = "SELECT * FROM blood_banks WHERE FIND_IN_SET('$blood_type', blood_types_available)";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<b style='color:red;font-size:25px;margin:10px'><center>No blood banks found with the selected blood type.</center></b>";
    }
}
?>

<form method="GET" action="">
    <label for="blood_type">Search by Blood Type:</label>
