			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Blood Banks List</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Blood Banks Info</div>
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->head_name);?></td>
                                            ...
                                            <td><?php echo htmlentities($result->blood_types_available);?></td>
										
										<td>

<a href="manage_blood_banks.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to delete this record')" class="btn btn-danger" style="margin-top:1%;"> Delete</a>
</td>
