...
<li><a href="manage-bloodgroup.php">Manage Blood Group</a></li>
				...
				<li><a href="manage_blood_banks.php"><i class="fa fa-users"></i> Blood Banks List</a></li>
				<li><a href="manage_blood_camps.php"><i class="fa fa-users"></i> Blood Camps List</a></li>
